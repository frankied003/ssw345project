...
export const getWeatherForZIP = async (zip) => {
    const getCoordsReq = await getRequest("https://maps.googleapis.com/maps/api/geocode/json", {
        address: zip,
    ...
    const weatherDataReq = await getRequest("https://api.openweathermap.org/data/2.5/onecall", {
        lat: latitude,
        lon: longitude,
        exclude: 'minutely',
